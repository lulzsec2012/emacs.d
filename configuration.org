...
#+begin_src emacs-lisp
  (defun my/gpt-refactor (gpt-backend gpt-model rewrite-message prompt)
...
#+begin_src emacs-lisp
  (use-package embark
    ...
    (defmacro my/define-embark-gpt-refactor (backend-sym &optional model-sym)
      ...
      (let* ((backend (eval backend-sym))
        ...
        `(defun ,fn (prompt)
           (let ((refactor-model ',model))
             (my/gpt-refactor ,backend-sym refactor-model my/gpt-refactor-prompt prompt)))))

    (define-key embark-file-map     (kbd "o") (my/embark-ace-action find-file))
    (define-key embark-buffer-map   (kbd "o") (my/embark-ace-action switch-to-buffer))
    (define-key embark-bookmark-map (kbd "o") (my/embark-ace-action bookmark-jump))

    (defvar-keymap gptel-anthropic-model-map
      :doc "Prefix: refactor code via Anthropic models"
      "s" (my/define-embark-gpt-refactor gptel--sonnet-thinking)
      "o" (my/define-embark-gpt-refactor gptel--opus-thinking))

    (defvar-keymap gptel-openrouter-model-map
      :doc "Prefix: select an OpenRouter model for refactoring"
      "o" (my/define-embark-gpt-refactor gptel--openrouter openai/gpt-5)
      "z" (my/define-embark-gpt-refactor gptel--openrouter z-ai/glm-4.6)
      "c" (my/define-embark-gpt-refactor gptel--openrouter openai/gpt-5-codex)
      "q" (my/define-embark-gpt-refactor gptel--openrouter qwen/qwen3-coder-plus)
      "d" (my/define-embark-gpt-refactor gptel--openrouter deepseek/deepseek-r1-0528)
      "x" (my/define-embark-gpt-refactor gptel--openrouter x-ai/grok-4))

    (fset 'gptel-anthropic-model-map gptel-anthropic-model-map)
    (fset 'gptel-openrouter-model-map gptel-openrouter-model-map)

    (keymap-set embark-region-map "g" (my/define-embark-gpt-refactor gptel--gemini))
    (keymap-set embark-region-map "a" 'gptel-anthropic-model-map)
    (keymap-set embark-region-map "d" (my/define-embark-gpt-refactor gptel--deepseek))
    (keymap-set embark-region-map "o" 'gptel-openrouter-model-map)
